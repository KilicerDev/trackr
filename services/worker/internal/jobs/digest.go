...
func buildDigestMessage(to, locale string, items []digestItem) mailMessage {
	...
	for _, it := range items {
		list.WriteString(fmt.Sprintf(
			`<tr><td style="padding:0 0 12px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;line-height:1.5;">`+
				`<a href="%s" target="_blank" style="color:#cf5447;text-decoration:none;">%s</a></td></tr>`,
			html.EscapeString(it.url), html.EscapeString(it.title)))
	}

	htmlBody := fmt.Sprintf(`<!doctype html>
<html lang="%s"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><meta name="color-scheme" content="light"/></head>
	...
	<table role="presentation" width="100%%" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;">
		<tr><td align="center" style="padding:0 16px;">
			<table role="presentation" width="448" cellpadding="0" cellspacing="0" border="0" style="width:100%%;max-width:448px;">
				<tr><td style="padding:44px 0 22px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:18px;font-weight:700;letter-spacing:-0.02em;color:#191a1e;">Trackr</td></tr>
				<tr><td style="background-color:#ffffff;border:1px solid #e4e2df;border-radius:16px;padding:28px 30px;box-shadow:0 14px 36px -12px rgba(40,30,30,0.16);">
					<table role="presentation" width="100%%" cellpadding="0" cellspacing="0" border="0">
						<tr><td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;line-height:1.6;color:#4e5054;padding:0 0 18px;">%s</td></tr>
						%s
					</table>
				</td></tr>
				<tr><td align="center" style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:11.5px;line-height:1.6;color:#909297;padding:22px 8px 44px;">Trackr · You received this digest because of activity on your account.</td></tr>
			</table>
		</td></tr>
	</table>
</body></html>`, locale, html.EscapeString(intro), list.String())
