    ...
    static let samples: [TicketItem] = {
        ...
        return [
            ...
            TicketItem(id: "WEBIM-31", subject: "Landing page form drops submissions every few minutes",
                       details: "Roughly every half hour the campaign form on the spring landing page returns an error and the submission is lost. Started after the hosting move on Monday.",
                       ...
                       linkedTasks: [
                           ConversionLink(uuid: "sample-trk-139", displayId: "TRK-139",
                                          title: "Fix dark mode colors in email templates",
                                          status: .inProgress),
                       ]),
