    ...
    static let samples: [ProjectItem] = {
        ...
        return [
            ProjectItem(key: "TRK", name: "Trackr Web", color: Color(hex: 0xFF4867),
                        about: "Ticketing, tasks and notes platform for the agency.",
            ...
            ProjectItem(key: "INF", name: "Infrastructure", color: Color(hex: 0x7FC8A9),
                        about: "Servers, Postgres, mail and deployments.",
                        status: .active, lead: users[1], members: [users[1]],
                        updatedAt: ago(hours: 26), isFavorite: true),
            ProjectItem(key: "SIWEB", name: "Siweb Shop Relaunch", color: Color(hex: 0xC08BD6),
                        about: "Shop relaunch on a new tech stack — no rework, fresh build.",
                        status: .planned, lead: users[2], members: [users[2], users[1]],
                        updatedAt: ago(hours: 3 * 24)),
            ProjectItem(key: "MAJA", name: "maja.studio Portfolio", color: Color(hex: 0xE9C46A),
                        about: "Portfolio site refresh with the new brand.",
