...
// Constructed on first use — better-auth rejects a missing BETTER_AUTH_SECRET
// in production at construction time, which would break the image build
// (see lazy.ts). The export keeps its full type.
