...
ALTER TABLE "mcp_access" ADD CONSTRAINT "mcp_access_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_access" ADD CONSTRAINT "mcp_access_enabled_by_id_user_id_fk" FOREIGN KEY ("enabled_by_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
